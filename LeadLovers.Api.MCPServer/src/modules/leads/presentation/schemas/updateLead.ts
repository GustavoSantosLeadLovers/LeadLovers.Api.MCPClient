...
export const updateLeadToolOutput = z.object(updateLeadOutputShape).or(
  z.object({
    StatusCode: z.enum(['ERROR', 'BadRequest', 'Unauthorized', 'NotFound']),
    Message: z.string().describe('Mensagem de erro caso a atualização falhe'),
  })
);

export type UpdateLeadToolInput = z.infer<typeof updateLeadToolInput>;
export type UpdateLeadToolOutput = z.infer<typeof updateLeadToolOutput>;
