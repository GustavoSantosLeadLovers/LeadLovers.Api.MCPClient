...
export const getLeadsOutputShape = {
  ...
  Links: z
    .object({
      Self: z.string().nullable().describe('Link para a página atual'),
      Next: z.string().nullable().describe('Link para a próxima página'),
      Prev: z.string().nullable().describe('Link para a página anterior'),
    })
